...
const tutorial = {
  "Welcome 🐻":["Welcome to MappingBuddy! 🌟 We're about to take a quick tour to explore the awesome features of Mapping Buddy. Click right where my magic wand points to begin the adventure! ✨🗺️",["35vw","35vh"],["60vw","55vh"], ".contentModal"],
    "Open Track Selector 🛤️":["Click the button labeled 'Open Track Selector' to embark on your journey! This is where you choose your major or track.",["65vw","20vh"],["89.5vw","10vh"], "#openTrack"],
...
$(document).ready(function() {
  ...
  if (first != true) {
    ...
    // generateKanban(loadedBoard[0].data.user[0].sem)
  }
