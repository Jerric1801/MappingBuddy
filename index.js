...
const colorList = ["IS217", "MGMT102", "MGMT106", "IS105"]
...
const recommended = ["MGMT102 Strategy","IS211 Interaction Design and Prototyping", "SMT.201 Geographic Information Systems for Urban Planning", "POSC101 Introduction to Public Policy", "IS216 Web Application Development II", "IS217 Analytics Foundation", "COR1305 Spreadsheet Modeling and Analytics",  "COR2222 AI for Social Transformation"]
var currentBoard = 0
var tabIndex = 0
var semIndex = 0
var cardIndex = 0
...
function createModule(text, clone = false, reco = false){
    ...
    if (colorList.includes(course_id)){
